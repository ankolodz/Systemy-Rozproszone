...
public interface ServerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return AllID(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String AllID(java.util.Map<String, String> context)
    {
        return _iceI_AllIDAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> AllIDAsync()
    {
        return _iceI_AllIDAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> AllIDAsync(java.util.Map<String, String> context)
    {
        return _iceI_AllIDAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_AllIDAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "AllID", null, sync, null);
